...
#define FIREBASE_HOST "home-security-92d7b.firebaseio.com"                         // the project name address from firebase id
#define FIREBASE_AUTH "sXN3hqKr4UgZUCfT1oDPDMEY3dOv3Od5KchZu40m"                    // the secret key generated from firebase
#define WIFI_SSID "SLT-Tharindu"                                          // input your home or public wifi name 
#define WIFI_PASSWORD "thakewifi"                                    //password of wifi ssid

String fireStatus = "";                                                     // led status received from firebase
int led = D4;                                                                // for external led
void setup() {
  Serial.begin(9600);
  delay(1000);
